...
print("The actual label for this image is: ", y_test[0])
...
print("Predicted probabilities:", y_preds)
print("Predicted labels:", y_pred_class)

from sklearn.metrics import roc_auc_score

print("AUC:", roc_auc_score(y_test, y_preds))
print("AUC with reversed prediction:", roc_auc_score(y_test, 1 - y_preds))
